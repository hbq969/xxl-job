 ...
 */
public class XxlJobInfo implements DictModel, DictAware {
    ...
    @Setter
    @Getter
    private String fmtTriggerLastTime;
    ...
    public void convertDict(SpringContext context) {
        ...
        if (addTime != null)
            this.fmtAddTime = FormatTime.YYYYMMDDHHMISS.withMills(this.addTime.getTime());
        if (updateTime != null)
            this.fmtUpdateTime = FormatTime.YYYYMMDDHHMISS.withMills(this.updateTime.getTime());
        if (triggerLastTime > 0)
            this.fmtTriggerLastTime = FormatTime.YYYYMMDDHHMISS.withMills(this.triggerLastTime);
        if (triggerNextTime > 0)
            this.fmtTriggerNextTime = FormatTime.YYYYMMDDHHMISS.withMills(this.triggerNextTime);
    }
